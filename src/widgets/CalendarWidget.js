...
class CalendarWidget extends React.Component {
  ...
  disableEditMode(e, saveState) {
    ...
    if(saveState == true && this.props.value) {
      ...
      <div class="row wa-widget">
        <div class="col">
          ...
          <div class="input-group">
            <input type="date" class="form-control" disabled={this.state.disabled} placeholder={"Enter " + this.props.label + " ..."} value={this.props.value}  onChange={(e) => {this.handleChange(e)}} />
            <div class="input-group-append">
              <button type="button" class={editButtonClasses} onClick={e => {this.enableEditMode(e)}}>
                  <i class="far fa-calendar"></i>&nbsp;Edit
              </button>
